...
The MOOC portion is free. The two exams carry the standard open university fees, and are free for University of Helsinki students.
...
Yes! Thanks to digitalization, cyber security is an issue that cuts across different industries and professions, so the knowledge and skills people learn in the course can be applied in a wide variety of careers. The first exam course focuses on a big picture. 

### What’s a good language to learn if I don’t have any coding experience?

The MOOC courses require Python knowledge. The first project can be done in any language, but Python is strongly recommended.
...
### Why isn’t my project graded yet?
While the programming exercises and puzzles are graded automatically,
the project reports need to be peer-reviewed and verified by staff. The verification is done regularly, see detailed descriptions on the relevant course page. 


### What does it take to get passed?
It depends on the course part. To pass an individual course certain amount of points need to be earned. The point thresholds are given in each course.

### How do I show someone I have passed a course part / get ETCS?
...
It is possible and it has been done. Sometimes extra paper work is needed.
It really depends on the University in question. We suggest discussing with your local study counselor beforehand.
...
you can still take the others.

### Is there going to be a CTF again?
CTF is done yearly during Period IV.
