...
<programming-exercise name="Hello Database" tmcname="part2-08.hellodatabase"  course="Introduction to Cyber Security: MOOC">
...
<programming-exercise name="Hello Insert" tmcname="part2-09.helloinsert" course="Introduction to Cyber Security: MOOC">
...
<programming-exercise name="Hello Web with a Database" tmcname="part2-10.hellowebwithdatabase" course="Introduction to Cyber Security: MOOC">
...
<programming-exercise name="Bank Transfer" tmcname="part2-11.banktransfer" course="Introduction to Cyber Security: MOOC">
...
<programming-exercise name="Simple Banking" tmcname="part2-12.simplebanking" course="Introduction to Cyber Security: MOOC">
